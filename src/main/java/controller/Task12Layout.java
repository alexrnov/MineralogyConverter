...
/**
 * Контроллер для интерфейса первой задачи Пробы с МСА и пустые (Web-ресурс).
 * В этой задаче используется набор excel-файлов, которые загружены с веб-ресурса "МСА по всем объектам"
 */
