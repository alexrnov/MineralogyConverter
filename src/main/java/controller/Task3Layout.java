 ...
 */
public class Task3Layout extends TaskLayout {

  @FXML private TextField inputFolderWithoutMSDTextField;
  @FXML private TextField inputFolderWithMSDTextField;
  @FXML private TextField outputFolderTextField;
  @FXML private TextField stratigraphicTextField;
  @FXML private Button inputFolderWithoutMSDButton;
  @FXML private Button inputFolderWithMSDButton;
  ...
  private void initialize() {
    ...
    createFolderButton(inputFolderWithoutMSDButton, inputFolderWithoutMSDTextField,
            new ImageView(getOpenDialogPath()));
    createFolderButton(inputFolderWithMSDButton, inputFolderWithMSDTextField,
            new ImageView(getOpenDialogPath()));
    ...
    inputFolderWithoutMSDTextField.focusedProperty().addListener((arg, oldValue, newValue) -> {
      if (newValue) {
        defaultStyle(inputFolderWithoutMSDTextField);
      }
    });

    inputFolderWithMSDTextField.focusedProperty().addListener((arg, oldValue, newValue) -> {
      if (newValue) {
        defaultStyle(inputFolderWithMSDTextField);
      }
    });
  ...
  private void runTask() {
    ...
    parameters.put("inputFolderWithoutMSD", inputFolderWithoutMSDTextField.getText());
    parameters.put("inputFolderWithMSD", inputFolderWithMSDTextField.getText());
  ...
  private boolean checkInputParameters() {
    boolean b = true;
    File inputFolderWithoutMSD = new File(inputFolderWithoutMSDTextField.getText());
    if (!inputFolderWithoutMSD.isDirectory()) {
      inputFolderWithoutMSDTextField.setStyle(getErrorStyleTextField());
      b = false;
    }

    File inputFolderWithMSD = new File(inputFolderWithMSDTextField.getText());
    if (!inputFolderWithMSD.isDirectory()) {
      inputFolderWithMSDTextField.setStyle(getErrorStyleTextField());
      b = false;
    }
