...
object StaticConstants {
  ...
  private val listOfMenuTasks: List<Pair<String, String>> = listOf(
          ...
          Pair("Границы опробования в точки", "/view/Task4Layout.fxml"),
          Pair("Пробы (ИСИХОГИ)", "/view/Task5Layout.fxml"),
          Pair("Устье/забой скважин (ИСИХОГИ)", "/view/Task6Layout.fxml"),
          Pair("Кровля/подошва пласта (ИСИХОГИ)", "/view/Task7Layout.fxml"),
          Pair("Интервалы пластов в точки (ИСИХОГИ)", "/view/Task8Layout.fxml"))
